...
//Declarando uma função sem parametro e sem retorno
    function exibirInformação(){
        console.log('Executei a funçãoexibir info')
    }
...
var resultado = 0
resultado = calcularDobro(5)
console.log(resultado)

//Declarando a função recebendo um parâmetro e retornando um valor
function calcularDobro(nr) {
    var dobro = nr * 2
    return dobro //Com o comando return "devolve" o valor calculado para a chamada
}

//Criando uma função e recebendo 2 valores/parâmetros e retornando a média
...
//Chamando a função de calculae média
